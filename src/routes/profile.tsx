...
function ProfilePage() {
  ...
  return <main style={pageStyle}><Nav /><h1 style={{ fontSize: 34, marginBottom: 8 }}>Candidate Profile</h1><p style={{ color: "#4b5563" }}>Keep reusable, user-owned facts in one private profile. 357Network never invents missing application answers.</p>
    <form onSubmit={save} style={panelStyle}>
      <h2 style={sectionHeading}>Contact & identity</h2><div style={gridStyle}>
        <Field id="full_name" label="Full name" value={form.full_name} set={setField} /><Field id="headline" label="Professional headline" value={form.headline} set={setField} />
        <Field id="email" label="Contact email" type="email" value={form.email} set={setField} /><Field id="phone" label="Phone" value={form.phone} set={setField} /><Field id="location" label="Location summary" value={form.location} set={setField} />
      </div>
      <h2 style={sectionHeading}>Address</h2><div style={gridStyle}>
        <Field id="address_line1" label="Street address" value={form.address_line1} set={setField} /><Field id="address_line2" label="Address line 2" value={form.address_line2} set={setField} />
      ...
      <h2 style={sectionHeading}>Professional links</h2><div style={gridStyle}><Field id="linkedin_url" label="LinkedIn" type="url" value={form.linkedin_url} set={setField} /><Field id="github_url" label="GitHub" type="url" value={form.github_url} set={setField} /><Field id="website_url" label="Website / portfolio" type="url" value={form.website_url} set={setField} /></div>
      <button disabled={busy} style={primaryButton}>{busy ? "Saving…" : "Save complete profile"}</button>
